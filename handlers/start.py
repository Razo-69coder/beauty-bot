...
WELCOME_TEXT = """
✨ *Добро пожаловать в Beauty Book!* ✨

Твоя умная записная книжка для мастера красоты 💅

Здесь ты можешь:
👥 Вести базу клиентов
📅 Записывать процедуры
🔔 Получать напоминания о клиентах
📸 Сохранять историю с фото
